...
#warning "******** where is no error processing !  *******"
	...
	strcat(buf,buf_temp);
	sprintf(buf_temp,"ip:'%d.%d.%d.%d',",FW_data.net.V_IP_CONFIG[0],FW_data.net.V_IP_CONFIG[1],FW_data.net.V_IP_CONFIG[2],FW_data.net.V_IP_CONFIG[3]);
	strcat(buf,buf_temp);
	sprintf(buf_temp,"gate:'%d.%d.%d.%d',",FW_data.net.V_IP_GET[0],FW_data.net.V_IP_GET[1],FW_data.net.V_IP_GET[2],FW_data.net.V_IP_GET[3]);
	strcat(buf,buf_temp);
	sprintf(buf_temp,"mask:'%d.%d.%d.%d',",FW_data.net.V_IP_MASK[0],FW_data.net.V_IP_MASK[1],FW_data.net.V_IP_MASK[2],FW_data.net.V_IP_MASK[3]);
	strcat(buf,buf_temp);
	...
	strcat(buf,buf_temp);
	sprintf(buf_temp,"dns_ip1:'%d.%d.%d.%d',",FW_data.net.V_IP_DNS[0],FW_data.net.V_IP_DNS[1],FW_data.net.V_IP_DNS[2],FW_data.net.V_IP_DNS[3]);
	strcat(buf,buf_temp);
