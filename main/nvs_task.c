...
{
	esp_err_t err=0;
	err = nvs_set_blob(nvs_data_handle,get_name(FW_data.net.V_IP_CONFIG),FW_data.net.V_IP_CONFIG,1);


	err =err|nvs_set_blob(nvs_data_handle,get_name(FW_data.net.V_IP_MASK),FW_data.net.V_IP_MASK,1);

//	err =err|nvs_set_i32(nvs_data_handle,get_name(FW_data.net.V_IP_MASK[1]=255;
//	err =err|nvs_set_i32(nvs_data_handle,get_name(FW_data.net.V_IP_MASK[2]=255;
//	err =err|nvs_set_i32(nvs_data_handle,get_name(FW_data.net.V_IP_MASK[3]=0;
//
	err=err|nvs_set_blob(nvs_data_handle,get_name(FW_data.net.V_IP_GET),FW_data.net.V_IP_GET,1);
//	err =err|nvs_set_i32(nvs_data_handle,get_name(FW_data.net.V_IP_GET[1]=168;
//	err =err|nvs_set_i32(nvs_data_handle,get_name(FW_data.net.V_IP_GET[2]=0;
//	err =err|nvs_set_i32(nvs_data_handle,get_name(FW_data.net.V_IP_GET[3]=1;
//
	err=err|nvs_set_u8(nvs_data_handle,get_name(FW_data.net.V_DHCP),FW_data.net.V_DHCP);
	err=err|nvs_set_blob(nvs_data_handle,get_name(FW_data.net.V_IP_DNS),FW_data.net.V_IP_DNS,1);
//	err =err|nvs_set_i32(nvs_data_handle,get_name(FW_data.net.V_IP_DNS[1]=0;
//	err =err|nvs_set_i32(nvs_data_handle,get_name(FW_data.net.V_IP_DNS[2]=0;
//	err =err|nvs_set_i32(nvs_data_handle,get_name(FW_data.net.V_IP_DNS[3]=18;

	err=err|nvs_set_blob(nvs_data_handle,get_name(FW_data.sys.V_FW1_VER),FW_data.sys.V_FW1_VER,1);
...
//    FW_data.sys.V_FW1_VER[3]=Bild;
   ...
   // FW_data.sys.V_BOOT_VER =0;// *((uint32_t *)A_BOOT_VER);
	...
	err=err|nvs_set_blob(nvs_data_handle,get_name(FW_data.http.V_LOGIN),FW_data.http.V_LOGIN,4);
//      memset((uint8_t*)&FW_data.V_LOGIN,0,16);
//     memcpy((uint32_t*)&FW_data.V_LOGIN, (uint32_t *)"visor", 5);
	err=err|nvs_set_blob(nvs_data_handle,get_name(FW_data.http.V_PASSWORD),FW_data.http.V_PASSWORD,4);
...
//     memcpy((uint32_t*)&FW_data.V_PASSWORD, (uint32_t *)"ping", 4);
	...
	err=err|nvs_set_blob(nvs_data_handle,get_name(FW_data.http.V_ON_MESS),FW_data.http.V_ON_MESS,8);
//	memset((uint8_t*)&FW_data.http.V_ON_MESS,0,32);
//    memcpy((uint8_t*)&FW_data.http.V_ON_MESS, (uint8_t *)"Power swich ON",14);
	err=err|nvs_set_blob(nvs_data_handle,get_name(FW_data.http.V_OFF_MESS),FW_data.http.V_OFF_MESS,8);
...
//    memcpy((uint8_t*)&FW_data.http.V_OFF_MESS, (uint8_t *)"Power swich OFF", 15);
   ...
   // FW_data.rasp.V_FLAG_EN_RASP =0;
    ...
    err=err|nvs_set_blob(nvs_data_handle,get_name(FW_data.smtp.V_EMAIL_ERR),FW_data.smtp.V_EMAIL_ERR,8);
