...
/* v2 by LBS 05.2009
*  Пробелы вокруг проверяемых значений считаются ошибкой!
*  Multicast ip и mac не проверяется
*/   
...
{ try 
 ...
 if(e==0 || e==255) msg+=". Широковещательные и специальные IP адреса недопустимы.";
 alert(msg);
 return false;
 }
}
...
var m2; if((/^ff:ff:ff:ff:ff:ff$/i).test(mac)) { r=false; m2=" Широковещательный адрес недопустим!"; }
if(!r) {  
